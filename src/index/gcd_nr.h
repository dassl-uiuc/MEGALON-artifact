...
private:
    ...
    alignas(
        64) int register_count[LOGICAL_NODE_NUM];  // bookkeep nr replica id registered thread count, assume 2 replicas
...
public:
    ...
    const NrFfi::NrMeta* GetNrMetaTid(bool lock = false);
