...
public:
    PageData(size_t num_pages, const std::shared_ptr<AllocatableLocalMemoryRegion>& nc_shm_region)
        ...
        page_data_base_addr_ = ncr_byte_allocator.allocate(common::BlockId::kBlockSize * num_pages);
