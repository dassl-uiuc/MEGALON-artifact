...
LOG_ROOT=${PROJECT_ROOT}/logs/eval3
RESULT_ROOT=${RACKOBJ_RESULT_DIR}eval3
        ...
        for workload in "${WORKLOADS[@]}"; do
            if [ $workload == "zipfian" ]; then
                ...
                for w_ratio in "${W_RATIOS[@]}"; do
                    ...
                    src_dir="${RACKOBJ_RESULT_DIR}hcmeta/${workload}-${w_ratio}"
...
#                             python3 analysis.py $dst_dir -t >> ${LOG_ROOT}/${variant}/stats.log 2>&1
#                         done
#                     done
#                 done
#             done
