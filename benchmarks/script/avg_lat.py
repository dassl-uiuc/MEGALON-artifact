...
We want to calculate:
    ...
    std deviation of average operation latency
    p50 operation latency
    p99 operation latency
    p99.9 operation latency
    avg write latency
    avg read latency
    avg remote operation latency
    avg owned operation latency
    avg remote miss/hit latency
    avg owned miss/hit latency
"""
